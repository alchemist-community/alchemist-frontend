...
const OperatePane: React.FC<OperatePaneProps> = (props) => {
  ...
  const unstake = async () => {
    ...
    if (cruciblesOnCurrentNetwork.length !== 0) {
      ...
      alert("You have not changed your network yet. Follow this guide to privately withdraw your stake- https://github.com/Taichi-Network/docs/blob/master/sendPriveteTx_tutorial.md");
      return;
    }
